        ...
        <nav className="navbar navbar-expand-lg navbar-dark bg-primary mb-4 rounded">
          <div className="container-fluid">
            <Link className="navbar-brand fw-bold d-flex align-items-center" to="/">
              <img src="/octofitapp-small.png" alt="OctoFit Logo" className="octofit-logo me-2" style={{height: '40px'}} />
              OctoFit Tracker
            </Link>
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              ...
              <span className="navbar-text">
                <a className="btn btn-outline-light btn-sm ms-2" href="https://github.com/" target="_blank" rel="noopener noreferrer">GitHub</a>
              </span>
            </div>
          </div>
        </nav>
